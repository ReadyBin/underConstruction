...
<span style="font-size:14px;">(Hinweis: Wenn die Hilfedatei (*.chm) nicht korrekt angezeigt werden sollte, sieh bitte im [CHM-HowTo](https://github.com/ReadyBin/underConstruction/blob/master/de/ChmHowTo.html) nach.)</span>
